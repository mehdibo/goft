...
func (m *mockAPI) GetUsers(page int, filters *map[string]string, sort *map[string]string) ([]*ftapi.User, error) {
	return nil, nil
}
func (m *mockAPI) ExpandUsers(users []*ftapi.User) (int, error) {
	return 0, nil
}
