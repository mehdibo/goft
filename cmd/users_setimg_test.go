...
func (m *setImgMockAPI) GetUsers(page int, filters *map[string]string, sort *map[string]string) ([]*ftapi.User, error) {
	return nil, nil
}
func (m *setImgMockAPI) ExpandUsers(users []*ftapi.User) (int, error) {
	return 0, nil
}
